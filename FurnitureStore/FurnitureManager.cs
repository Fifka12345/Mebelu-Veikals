...
namespace FurnitureStore
{
    public class FurnitureManager
    {
        ...
        public void UpdateFurnitureByName(string name, string newName, string description, double price, int height, int width, int length)
        {
            using (var connection = new SqliteConnection(connectionString))
            {
                connection.Open();
            ...
            UPDATE Furniture
            SET Name = @newName, Description = @description, Price = @price, Height = @height, Width = @width, Length = @length
            WHERE Name = @name";
